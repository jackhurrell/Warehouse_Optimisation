...
Partial Class Main_form
    ...
    Private Sub InitializeComponent()
        ...
        ' btnAddWarehouses
        ' 
        btnAddWarehouses.Location = New Point(12, 12)
        btnAddWarehouses.Name = "btnAddWarehouses"
        btnAddWarehouses.Size = New Size(152, 54)
        btnAddWarehouses.TabIndex = 4
        btnAddWarehouses.Text = "FOR DEVELOPMENT ONLY ADDS IN TEMPLATE WAREHOUSES"
        btnAddWarehouses.UseVisualStyleBackColor = True
        ' 
        ' Button1
        ' 
    ...
    Friend WithEvents btnAddWarehouses As Button
