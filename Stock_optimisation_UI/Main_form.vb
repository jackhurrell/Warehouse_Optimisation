...
Public Class Main_form
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnAddWarehouses.Click
        ...
        Me.WarehouseInputs = New List(Of Warehouse_inputs) From {Warehouse_inputs_1, Warehouse_inputs_3, Warehouse_inputs_2}
        ...
        Me.ReorderRelations = New List(Of (Integer, Integer, Reorder_inputs)) From {reorder_inputs_1, reorder_inputs_2, reorder_inputs_3}
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        Dim newMapForm As New MapsForm()
    ...
    Private Sub StockWizardBox_Enter(sender As Object, e As EventArgs) Handles StockWizardBox.Enter
